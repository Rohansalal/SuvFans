    ...
    details: [
      {
        ...
        content: 'The fan housing is constructed of rigid structural members and formed galvanized steel panels. Aluminum construction is optional. Built from heavy-gauge steel for long-term durability in demanding industrial environments.'
      },
      {
        title: 'Wheel',
        content: 'A backward inclined, non-overloading centrifugal wheel is utilized to deliver maximum efficiency. Each wheel is statically and dynamically balanced for smooth, vibration-free operation.'
      },
      {
        title: 'Duct Collars',
      ...
      {
        title: 'Motor',
        content: 'Permanently lubricated, sealed ball bearing motors are selected to provide years of trouble-free operation with minimal maintenance.'
      },
      {
